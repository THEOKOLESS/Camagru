...
MYSQL_PIDFILE=/Users/tvitoux/Mamp/mysql/data/mysqld.pid

MYSQL_START="/Users/tvitoux/Mamp/mysql/bin/mysqld_safe --defaults-file=/Users/tvitoux/Mamp/mysql/my.cnf --mysqld=mysqld.bin --socket=/Users/tvitoux/Mamp/mysql/tmp/mysql.sock  --datadir=/Users/tvitoux/Mamp/mysql/data --log-error=/Users/tvitoux/Mamp/mysql/data/mysqld.log  --pid-file=$MYSQL_PIDFILE --lower-case-table-names=1 "
