...
will be accessible at http://localhost:8080/demo

You should copy the "demo" folder into the /Users/tvitoux/Mamp/apps 
folder and add the following line at the end of the
/Users/tvitoux/Mamp/apache2/conf/bitnami/bitnami-apps-prefix.conf

Include "/Users/tvitoux/Mamp/apps/demo/conf/httpd-prefix.conf"

Then restart the Apache server. You can use the graphical Manager tool 
that you can find in your installation directory.

Go to your browser at http://localhost:8080/demo and
...
configuration in the "/Users/tvitoux/Mamp/apache2/conf/bitnami/bitnami-apps-prefix.conf" file

#Include "/Users/tvitoux/Mamp/apps/demo/conf/httpd-prefix.conf"

and enable the new Virtual Host configuration file in the 
"/Users/tvitoux/Mamp/apache2/conf/bitnami/bitnami-apps-vhosts.conf" file:

Include "/Users/tvitoux/Mamp/apps/demo/conf/httpd-vhosts.conf"
